...
C<local>               - inside of a map_r, treated as a private thread variable

C<sub_r>               - 'thread safe' atomic subroutine, (critical section; like 'atomic' but for executed blocks)

C<*_r>                 - current perl5 supported keywords, functions, etc maybe used with a '_r' to indicated
